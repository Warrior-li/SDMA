set moduleName dfm_Pipeline_VITIS_LOOP_114_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dfm_Pipeline_VITIS_LOOP_114_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem6 int 32 regular {axi_master 0}  }
	{ sext_ln114 int 62 regular  }
	{ K int 30 regular  }
	{ trunc_ln111_1 int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem6", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B4","offset": { "type": "dynamic","port_name": "B4","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "trunc_ln111_1", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ trunc_ln111_1 sc_in sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln111_1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "trunc_ln111_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	trunc_ln111_1 { ap_none {  { trunc_ln111_1 in_data 0 16 } } }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "1073741826"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "1073741826"}
]}
