set moduleName pe_Pipeline_VITIS_LOOP_76_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pe_Pipeline_VITIS_LOOP_76_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ half int 32 regular  }
	{ trunc_ln96_1 int 20 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "half", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "trunc_ln78_1", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "conv_i_i", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln96_3", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ trunc_ln96_1 sc_in sc_lv 20 signal 1 } 
	...
	{ trunc_ln78_1 sc_in sc_lv 3 signal 10 } 
	{ conv_i_i sc_in sc_lv 32 signal 11 } 
	{ trunc_ln96_3 sc_in sc_lv 16 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln96_1", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "trunc_ln96_1", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln78_1", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "trunc_ln78_1", "role": "default" }} , 
 	{ "name": "conv_i_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv_i_i", "role": "default" }} , 
 	{ "name": "trunc_ln96_3", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "trunc_ln96_3", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_83_32_1_1_U138", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	trunc_ln96_1 { ap_none {  { trunc_ln96_1 in_data 0 20 } } }
	...
	trunc_ln78_1 { ap_none {  { trunc_ln78_1 in_data 0 3 } } }
	conv_i_i { ap_none {  { conv_i_i in_data 0 32 } } }
	trunc_ln96_3 { ap_none {  { trunc_ln96_3 in_data 0 16 } } }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_76_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter6", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter6", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_83_32_1_1_U144", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}
...
set portList { 
	...
	{ trunc_ln96_1 sc_in sc_lv 20 signal 9 } 
	...
	{ trunc_ln78_1 sc_in sc_lv 3 signal 18 } 
	{ conv_i_i sc_in sc_lv 32 signal 19 } 
	{ trunc_ln96_3 sc_in sc_lv 16 signal 20 } 
