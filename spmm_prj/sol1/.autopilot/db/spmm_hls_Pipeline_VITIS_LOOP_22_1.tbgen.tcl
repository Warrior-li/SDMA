set moduleName spmm_hls_Pipeline_VITIS_LOOP_22_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {spmm_hls_Pipeline_VITIS_LOOP_22_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln22 int 58 regular  }
	{ n_block int 30 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "n_block", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ A_stream_din sc_out sc_lv 64 signal 3 } 
	{ A_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ A_stream_write sc_out sc_logic 1 signal 3 } 
	{ sext_ln22 sc_in sc_lv 58 signal 1 } 
	{ n_block sc_in sc_lv 30 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "n_block", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "n_block", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "spmm_hls_Pipeline_VITIS_LOOP_22_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "n_block", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	spmm_hls_Pipeline_VITIS_LOOP_22_1 {
		gmem0 {Type I LastRead 1 FirstWrite -1}
		sext_ln22 {Type I LastRead 0 FirstWrite -1}
		n_block {Type I LastRead 0 FirstWrite -1}
		A_stream {Type O LastRead -1 FirstWrite 2}}}
...
set Spec2ImplPortList { 
	...
	n_block { ap_none {  { n_block in_data 0 30 } } }
