...
set portList { 
	...
	{ K_c_din sc_out sc_lv 32 signal 1 } 
	{ K_c_full_n sc_in sc_logic 1 signal 1 } 
	{ K_c_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	K_c { ap_fifo {  { K_c_din fifo_port_we 1 32 }  { K_c_full_n fifo_status 0 1 }  { K_c_write fifo_data 1 1 } } }
}
