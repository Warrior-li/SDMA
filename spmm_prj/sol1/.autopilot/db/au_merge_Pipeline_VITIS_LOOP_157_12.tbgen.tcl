set moduleName au_merge_Pipeline_VITIS_LOOP_157_12
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {au_merge_Pipeline_VITIS_LOOP_157_12}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln199 int 30 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln199", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ streamB39_dout sc_in sc_lv 32 signal 2 } 
	{ streamB39_empty_n sc_in sc_logic 1 signal 2 } 
	{ streamB39_read sc_out sc_logic 1 signal 2 } 
	{ zext_ln199 sc_in sc_lv 30 signal 0 } 
	{ AU1_address0 sc_out sc_lv 16 signal 3 } 
	{ AU1_ce0 sc_out sc_logic 1 signal 3 } 
	{ AU1_we0 sc_out sc_logic 1 signal 3 } 
	{ AU1_d0 sc_out sc_lv 32 signal 3 } 
	{ AU1_address1 sc_out sc_lv 16 signal 3 } 
	{ AU1_ce1 sc_out sc_logic 1 signal 3 } 
	{ AU1_q1 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln199", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "zext_ln199", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_7_full_dsp_1_U108", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_7_full_dsp_1_U109", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "1073741840"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "1073741840"}
]}
...
set Spec2ImplPortList { 
	zext_ln199 { ap_none {  { zext_ln199 in_data 0 30 } } }
