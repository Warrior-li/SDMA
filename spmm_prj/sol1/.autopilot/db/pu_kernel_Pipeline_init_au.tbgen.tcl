set moduleName pu_kernel_Pipeline_init_au
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pu_kernel_Pipeline_init_au}
...
set C_modelArgList {
	{ K int 30 regular  }
	{ AU0 float 32 regular {array 61278 { 0 3 } 0 1 }  }
	{ AU1 float 32 regular {array 61278 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "K", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
 	{ "Name" : "AU0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "AU1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
# RTL Port declarations: 
set portNum 15
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	...
	{ ap_idle sc_out sc_logic 1 done -1 } 
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ K sc_in sc_lv 30 signal 0 } 
	{ AU0_address0 sc_out sc_lv 16 signal 1 } 
	{ AU0_ce0 sc_out sc_logic 1 signal 1 } 
	{ AU0_we0 sc_out sc_logic 1 signal 1 } 
	{ AU0_d0 sc_out sc_lv 32 signal 1 } 
	{ AU1_address0 sc_out sc_lv 16 signal 2 } 
	{ AU1_ce0 sc_out sc_logic 1 signal 2 } 
	{ AU1_we0 sc_out sc_logic 1 signal 2 } 
	{ AU1_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	{ "name": "ap_rst", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "reset", "bundle":{"name": "ap_rst", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "1073741825"}
...
set Spec2ImplPortList { 
	...
	AU0 { ap_memory {  { AU0_address0 mem_address 1 16 }  { AU0_ce0 mem_ce 1 1 }  { AU0_we0 mem_we 1 1 }  { AU0_d0 mem_din 1 32 } } }
	AU1 { ap_memory {  { AU1_address0 mem_address 1 16 }  { AU1_ce0 mem_ce 1 1 }  { AU1_we0 mem_we 1 1 }  { AU1_d0 mem_din 1 32 } } }
}
