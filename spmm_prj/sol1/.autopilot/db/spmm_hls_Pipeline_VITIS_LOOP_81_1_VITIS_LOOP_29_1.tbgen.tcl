set moduleName spmm_hls_Pipeline_VITIS_LOOP_81_1_VITIS_LOOP_29_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {spmm_hls_Pipeline_VITIS_LOOP_81_1_VITIS_LOOP_29_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln38 int 33 regular  }
	{ A_stream int 64 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln38", "interface" : "wire", "bitwidth" : 33, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln38 sc_in sc_lv 33 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln38", "direction": "in", "datatype": "sc_lv", "bitwidth":33, "type": "signal", "bundle":{"name": "zext_ln38", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "spmm_hls_Pipeline_VITIS_LOOP_81_1_VITIS_LOOP_29_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_81_1_VITIS_LOOP_29_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter1", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	spmm_hls_Pipeline_VITIS_LOOP_81_1_VITIS_LOOP_29_1 {
...
set Spec2ImplPortList { 
	zext_ln38 { ap_none {  { zext_ln38 in_data 0 33 } } }
