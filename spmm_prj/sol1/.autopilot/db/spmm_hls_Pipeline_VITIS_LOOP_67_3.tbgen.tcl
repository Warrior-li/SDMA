set moduleName spmm_hls_Pipeline_VITIS_LOOP_67_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {spmm_hls_Pipeline_VITIS_LOOP_67_3}
...
set portList { 
	...
	{ cmp_i_i sc_in sc_lv 1 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "spmm_hls_Pipeline_VITIS_LOOP_67_3",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_67_3", "PipelineType" : "NotSupport"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	spmm_hls_Pipeline_VITIS_LOOP_67_3 {
