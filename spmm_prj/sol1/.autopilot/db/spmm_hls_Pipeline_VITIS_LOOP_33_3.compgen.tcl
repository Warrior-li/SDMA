...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln33_2 \
    op interface \
    ports { sext_ln33_2 { I 35 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln33_1 \
    op interface \
    ports { trunc_ln33_1 { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { A_stream_din { O 64 vector } A_stream_full_n { I 1 bit } A_stream_write { O 1 bit } } \
} "
}
