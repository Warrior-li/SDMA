set moduleName pe_Pipeline_VITIS_LOOP_78_173
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pe_Pipeline_VITIS_LOOP_78_173}
...
set C_modelArgList {
	...
	{ add_ln80_8 int 3 regular  }
	{ conv_i_i float 32 regular  }
	{ add_ln99_1 int 16 regular  }
	{ add_ln80_9 int 3 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "len_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln99", "interface" : "wire", "bitwidth" : 20, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln80_8", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "conv_i_i", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln99_1", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln80_9", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ add_ln99 sc_in sc_lv 20 signal 9 } 
	...
	{ add_ln80_8 sc_in sc_lv 3 signal 18 } 
	{ conv_i_i sc_in sc_lv 32 signal 19 } 
	{ add_ln99_1 sc_in sc_lv 16 signal 20 } 
	{ add_ln80_9 sc_in sc_lv 3 signal 21 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln99", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "add_ln99", "role": "default" }} , 
 	...
 	{ "name": "add_ln80_8", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "add_ln80_8", "role": "default" }} , 
 	{ "name": "conv_i_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv_i_i", "role": "default" }} , 
 	{ "name": "add_ln99_1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "add_ln99_1", "role": "default" }} , 
 	{ "name": "add_ln80_9", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "add_ln80_9", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln99 { ap_none {  { add_ln99 in_data 0 20 } } }
	...
	add_ln80_8 { ap_none {  { add_ln80_8 in_data 0 3 } } }
	conv_i_i { ap_none {  { conv_i_i in_data 0 32 } } }
	add_ln99_1 { ap_none {  { add_ln99_1 in_data 0 16 } } }
	add_ln80_9 { ap_none {  { add_ln80_9 in_data 0 3 } } }
}
