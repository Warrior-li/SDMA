...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename pkt_v_value \
    op interface \
    ports { pkt_v_value_address0 { O 2 vector } pkt_v_value_ce0 { O 1 bit } pkt_v_value_we0 { O 1 bit } pkt_v_value_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pkt_v_value'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pkt_v_y \
    op interface \
    ports { pkt_v_y_address0 { O 2 vector } pkt_v_y_ce0 { O 1 bit } pkt_v_y_we0 { O 1 bit } pkt_v_y_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pkt_v_y'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pkt_ref \
    op interface \
    ports { pkt_ref_address0 { O 2 vector } pkt_ref_ce0 { O 1 bit } pkt_ref_we0 { O 1 bit } pkt_ref_d0 { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pkt_ref'"
}
}
...
eval "cg_default_interface_gen_dc { \
    id 5 \
    name seen_v_3_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_seen_v_3_reload \
    op interface \
    ports { seen_v_3_reload { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name seen_v_2_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_seen_v_2_reload \
    op interface \
    ports { seen_v_2_reload { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 7 \
    name seen_v_1_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_seen_v_1_reload \
    op interface \
    ports { seen_v_1_reload { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_seen_v_reload \
    op interface \
    ports { seen_v_reload { I 1 vector } } \
} "
}
