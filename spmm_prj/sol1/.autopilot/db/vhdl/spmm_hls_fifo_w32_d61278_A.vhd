...
entity spmm_hls_fifo_w32_d61278_A is
    generic (
...
architecture arch of spmm_hls_fifo_w32_d61278_A is

    -- component
    component spmm_hls_fifo_w32_d61278_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_spmm_hls_fifo_w32_d61278_A_ram : spmm_hls_fifo_w32_d61278_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity spmm_hls_fifo_w32_d61278_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 16;
...
architecture arch of spmm_hls_fifo_w32_d61278_A_ram is
