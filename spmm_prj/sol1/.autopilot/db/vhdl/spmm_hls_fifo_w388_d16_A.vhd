...
entity spmm_hls_fifo_w388_d16_A is
    generic (
        MEM_STYLE         : string  := "auto";
        DATA_WIDTH        : integer := 388;
...
architecture arch of spmm_hls_fifo_w388_d16_A is

    -- component
    component spmm_hls_fifo_w388_d16_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 388;
...
begin
----------------------- Instantiation -----------------------
    U_spmm_hls_fifo_w388_d16_A_ram : spmm_hls_fifo_w388_d16_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity spmm_hls_fifo_w388_d16_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 388;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of spmm_hls_fifo_w388_d16_A_ram is
