...
entity spmm_hls_control_r_s_axi is
generic (
...
end entity spmm_hls_control_r_s_axi;
...
architecture behave of spmm_hls_control_r_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_B_DATA_0 : INTEGER := 16#10#;
    constant ADDR_B_DATA_1 : INTEGER := 16#14#;
    constant ADDR_B_CTRL   : INTEGER := 16#18#;
