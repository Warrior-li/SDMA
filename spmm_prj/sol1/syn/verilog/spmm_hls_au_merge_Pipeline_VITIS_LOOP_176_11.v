...
module spmm_hls_au_merge_Pipeline_VITIS_LOOP_176_11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] add_i1_reg_204;
wire   [31:0] grp_fu_104_p2;
reg   [31:0] add4_i1_reg_209;
wire   [63:0] i_4_cast5_fu_132_p1;
reg   [15:0] i_4_fu_44;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln176_fu_120_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        AU0_addr_reg_162 <= i_4_cast5_fu_132_p1;
        AU1_addr_reg_168 <= i_4_cast5_fu_132_p1;
    end
end
...
assign AU0_address1 = i_4_cast5_fu_132_p1;

assign AU0_d0 = add_i1_reg_204;

assign AU1_address0 = AU1_addr_reg_168_pp0_iter8_reg;

assign AU1_address1 = i_4_cast5_fu_132_p1;

assign AU1_d0 = add4_i1_reg_209;
...
assign i_4_cast1_fu_116_p1 = ap_sig_allocacmp_i;

assign i_4_cast5_fu_132_p1 = ap_sig_allocacmp_i;

assign icmp_ln176_fu_120_p2 = ((i_4_cast1_fu_116_p1 < zext_ln176) ? 1'b1 : 1'b0);

endmodule //spmm_hls_au_merge_Pipeline_VITIS_LOOP_176_11
