...
attribute shreg_extract : string;
    ...
    signal trunc_ln151_9_reg_317 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln151_1_reg_322 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_5_reg_327 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_reg_332 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_done : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_idle : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_ready : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_v_y_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_v_y_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_we0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_ref_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_ref_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_we0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_d0 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start_reg : STD_LOGIC := '0';
    ...
    component spmm_hls_pu_kernel_8_tile_y_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component spmm_hls_pu_kernel_8_tile_ref_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    ...
    tile_y_U : component spmm_hls_pu_kernel_8_tile_y_RAM_AUTO_1R1W
    generic map (
        DataWidth => 32,
        AddressRange => 4,
        AddressWidth => 2)
    port map (
        ...
        ce0 => tile_y_ce0,
        we0 => tile_y_we0,
        d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_d0,
        q0 => tile_y_q0);

    tile_ref_U : component spmm_hls_pu_kernel_8_tile_ref_RAM_AUTO_1R1W
    generic map (
        DataWidth => 1,
        AddressRange => 4,
        AddressWidth => 2)
    port map (
        ...
        ce0 => tile_ref_ce0,
        we0 => tile_ref_we0,
        d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_d0,
        q0 => tile_ref_q0);
    ...
    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210 : component spmm_hls_pu_kernel_8_Pipeline_pu_save_stream_into_pu
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start,
        ap_done => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_done,
        ap_idle => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_idle,
        ap_ready => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_ready,
        p_v_y_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_v_y_address0,
        p_v_y_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_v_y_ce0,
        p_v_y_q0 => p_v_y_q0,
        tile_y_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_address0,
        tile_y_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_ce0,
        tile_y_we0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_we0,
        tile_y_d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_d0,
        p_ref_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_ref_address0,
        p_ref_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_ref_ce0,
        p_ref_q0 => p_ref_q0,
        tile_ref_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_address0,
        tile_ref_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_ce0,
        tile_ref_we0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_we0,
        tile_ref_d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_d0);
    ...
    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_ready = ap_const_logic_1)) then 
                    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                tmp_5_reg_327 <= s_12_dout(386 downto 386);
                tmp_6_reg_332 <= s_12_dout(387 downto 387);
                trunc_ln151_1_reg_322 <= s_12_dout(383 downto 352);
                trunc_ln151_9_reg_317 <= s_12_dout(287 downto 256);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, s_12_empty_n, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_done, grp_dfm_fu_218_ap_done, ap_CS_fsm_state4, ap_CS_fsm_state6)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_done = ap_const_logic_1))) then
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_done)
    begin
        if ((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_done = ap_const_logic_0)) then 
    ...
    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start <= grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_ap_start_reg;
    m_axi_gmem4_ARADDR <= grp_dfm_fu_218_m_axi_gmem6_ARADDR;
    m_axi_gmem4_ARBURST <= grp_dfm_fu_218_m_axi_gmem6_ARBURST;
    m_axi_gmem4_ARCACHE <= grp_dfm_fu_218_m_axi_gmem6_ARCACHE;
    m_axi_gmem4_ARID <= grp_dfm_fu_218_m_axi_gmem6_ARID;
    m_axi_gmem4_ARLEN <= grp_dfm_fu_218_m_axi_gmem6_ARLEN;
    m_axi_gmem4_ARLOCK <= grp_dfm_fu_218_m_axi_gmem6_ARLOCK;
    m_axi_gmem4_ARPROT <= grp_dfm_fu_218_m_axi_gmem6_ARPROT;
    m_axi_gmem4_ARQOS <= grp_dfm_fu_218_m_axi_gmem6_ARQOS;
    m_axi_gmem4_ARREGION <= grp_dfm_fu_218_m_axi_gmem6_ARREGION;
    m_axi_gmem4_ARSIZE <= grp_dfm_fu_218_m_axi_gmem6_ARSIZE;
    m_axi_gmem4_ARUSER <= grp_dfm_fu_218_m_axi_gmem6_ARUSER;

    m_axi_gmem4_ARVALID_assign_proc : process(ap_CS_fsm_state5, grp_dfm_fu_218_m_axi_gmem6_ARVALID, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            m_axi_gmem4_ARVALID <= grp_dfm_fu_218_m_axi_gmem6_ARVALID;
        else 
    ...
    m_axi_gmem4_RREADY_assign_proc : process(ap_CS_fsm_state5, grp_dfm_fu_218_m_axi_gmem6_RREADY, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            m_axi_gmem4_RREADY <= grp_dfm_fu_218_m_axi_gmem6_RREADY;
        else 
    ...
    p_ref_address0_assign_proc : process(ap_CS_fsm_state1, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_ref_address0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
    ...
    p_ref_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, s_12_empty_n, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_ref_ce0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
    ...
    p_ref_d0_assign_proc : process(ap_CS_fsm_state1, s_12_dout, tmp_6_reg_332, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_ref_d0 <= tmp_6_reg_332;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    p_ref_d1_assign_proc : process(ap_CS_fsm_state1, s_12_dout, tmp_5_reg_327, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_ref_d1 <= tmp_5_reg_327;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    p_v_y_address0_assign_proc : process(ap_CS_fsm_state1, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_v_y_address0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    p_v_y_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, s_12_empty_n, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_p_v_y_ce0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or (not(((s_12_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    p_v_y_d0_assign_proc : process(ap_CS_fsm_state1, s_12_dout, trunc_ln151_1_reg_322, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_v_y_d0 <= trunc_ln151_1_reg_322;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    p_v_y_d1_assign_proc : process(ap_CS_fsm_state1, s_12_dout, trunc_ln151_9_reg_317, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_v_y_d1 <= trunc_ln151_9_reg_317;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    tile_ref_address0_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_address0, grp_dfm_fu_218_tile_ref_address0, ap_CS_fsm_state4, ap_CS_fsm_state6)
    begin
    ...
    tile_ref_ce0_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_ce0, grp_dfm_fu_218_tile_ref_ce0, ap_CS_fsm_state4, ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            tile_ref_ce0 <= grp_dfm_fu_218_tile_ref_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    tile_ref_we0_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_ref_we0, ap_CS_fsm_state4)
    begin
    ...
    tile_y_address0_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_address0, grp_dfm_fu_218_tile_y_address0, ap_CS_fsm_state4, ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            tile_y_address0 <= grp_dfm_fu_218_tile_y_address0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    tile_y_ce0_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_ce0, grp_dfm_fu_218_tile_y_ce0, ap_CS_fsm_state4, ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            tile_y_ce0 <= grp_dfm_fu_218_tile_y_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    tile_y_we0_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_we0, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            tile_y_we0 <= grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_210_tile_y_we0;
        else 
