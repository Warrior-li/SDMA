...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, s_0_full_n, s_1_full_n, s_2_full_n, s_3_full_n, ap_CS_fsm_state7, grp_set_tile_broadcast_Pipeline_init_seen_fu_263_ap_done, grp_set_tile_broadcast_Pipeline_copy_tile_loop_fu_271_ap_done, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
    ...
    ap_ready_assign_proc : process(s_0_full_n, s_1_full_n, s_2_full_n, s_3_full_n, ap_CS_fsm_state7)
    begin
        if ((not(((s_3_full_n = ap_const_logic_0) or (s_2_full_n = ap_const_logic_0) or (s_1_full_n = ap_const_logic_0) or (s_0_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
