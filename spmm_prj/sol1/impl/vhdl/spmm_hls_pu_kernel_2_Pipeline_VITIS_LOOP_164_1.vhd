...
entity spmm_hls_pu_kernel_2_Pipeline_VITIS_LOOP_164_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of spmm_hls_pu_kernel_2_Pipeline_VITIS_LOOP_164_1 is 
...
attribute shreg_extract : string;
    ...
    signal empty_49_fu_132_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal empty_49_reg_167 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal i_3_cast_i_fu_115_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_3_fu_46 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component spmm_hls_pu_kernel_2_Pipeline_VITIS_LOOP_164_1_resA_RAM_AUTO_0R0W IS
    generic (
        DataWidth : INTEGER;
...
begin
    resA_U : component spmm_hls_pu_kernel_2_Pipeline_VITIS_LOOP_164_1_resA_RAM_AUTO_0R0W
    generic map (
        DataWidth => 32,
        AddressRange => 61278,
        AddressWidth => 16)
    ...
    resB_U : component spmm_hls_pu_kernel_2_Pipeline_VITIS_LOOP_164_1_resA_RAM_AUTO_0R0W
    generic map (
        DataWidth => 32,
        AddressRange => 61278,
        AddressWidth => 16)
    ...
    i_3_fu_46_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                i_3_fu_46 <= ap_const_lv2_1;
    ...
    add_ln164_fu_121_p2 <= std_logic_vector(unsigned(i_3_fu_46) + unsigned(ap_const_lv2_1));
    ...
    empty_49_fu_132_p1 <= tile_y_q0(16 - 1 downto 0);
    grp_pu_comp_fu_90_ap_start <= grp_pu_comp_fu_90_ap_start_reg;
    i_3_cast_i_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_3_fu_46),64));
    icmp_ln164_fu_109_p2 <= "1" when (i_3_fu_46 = ap_const_lv2_3) else "0";
    ...
    tile_value_address0 <= i_3_cast_i_fu_115_p1(2 - 1 downto 0);
    ...
    tile_y_address0 <= i_3_cast_i_fu_115_p1(2 - 1 downto 0);
