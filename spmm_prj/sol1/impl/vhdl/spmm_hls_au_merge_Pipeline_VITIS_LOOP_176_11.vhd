...
entity spmm_hls_au_merge_Pipeline_VITIS_LOOP_176_11 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of spmm_hls_au_merge_Pipeline_VITIS_LOOP_176_11 is 
...
attribute shreg_extract : string;
    ...
    signal add_i1_reg_204 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_104_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add4_i1_reg_209 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_4_cast5_fu_132_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_4_fu_44 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal i_4_cast1_fu_116_p1 : STD_LOGIC_VECTOR (29 downto 0);
...
begin
    fadd_32ns_32ns_32_7_full_dsp_1_U114 : component spmm_hls_fadd_32ns_32ns_32_7_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 7,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_7_full_dsp_1_U115 : component spmm_hls_fadd_32ns_32ns_32_7_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 7,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln176_fu_120_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                AU0_addr_reg_162 <= i_4_cast5_fu_132_p1(16 - 1 downto 0);
                AU1_addr_reg_168 <= i_4_cast5_fu_132_p1(16 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                add4_i1_reg_209 <= grp_fu_104_p2;
                add_i1_reg_204 <= grp_fu_100_p2;
    ...
    AU0_address1 <= i_4_cast5_fu_132_p1(16 - 1 downto 0);
    ...
    AU1_address1 <= i_4_cast5_fu_132_p1(16 - 1 downto 0);
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_4_fu_44, ap_loop_init)
    begin
    ...
    i_4_cast1_fu_116_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),30));
    i_4_cast5_fu_132_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),64));
    icmp_ln176_fu_120_p2 <= "1" when (unsigned(i_4_cast1_fu_116_p1) < unsigned(zext_ln176)) else "0";
