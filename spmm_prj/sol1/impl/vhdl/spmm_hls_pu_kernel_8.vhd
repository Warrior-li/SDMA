...
entity spmm_hls_pu_kernel_8 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of spmm_hls_pu_kernel_8 is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln151_9_reg_467 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln151_1_reg_472 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_5_reg_477 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_reg_482 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem4_addr_reg_540 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state10 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state10 : signal is "none";
    signal add_ln114_2_fu_450_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal add_ln114_2_reg_549 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_idle : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_ready : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_we0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_ce0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_we0 : STD_LOGIC;
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_d0 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_reg_271 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_CS_fsm_state17 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state17 : signal is "none";
    signal grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg : STD_LOGIC := '0';
    ...
    signal trunc_ln6_fu_425_p4 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    component spmm_hls_pu_kernel_8_Pipeline_pu_save_stream_into_pu IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        ce0 => tile_y_ce0,
        we0 => tile_y_we0,
        d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_d0,
        q0 => tile_y_q0);
    ...
    port map (
        ...
        ce0 => tile_ref_ce0,
        we0 => tile_ref_we0,
        d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_d0,
        q0 => tile_ref_q0);
    ...
    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282 : component spmm_hls_pu_kernel_8_Pipeline_pu_save_stream_into_pu
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start,
        ap_done => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done,
        ap_idle => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_idle,
        ap_ready => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_ready,
        p_v_y_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_address0,
        p_v_y_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_ce0,
        p_v_y_q0 => p_v_y_q0,
        tile_y_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_address0,
        tile_y_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_ce0,
        tile_y_we0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_we0,
        tile_y_d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_d0,
        p_ref_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_address0,
        p_ref_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_ce0,
        p_ref_q0 => p_ref_q0,
        tile_ref_address0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_address0,
        tile_ref_ce0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_ce0,
        tile_ref_we0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_we0,
        tile_ref_d0 => grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_d0);

    mul_32s_30ns_32_2_1_U48 : component spmm_hls_mul_32s_30ns_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_ready = ap_const_logic_1)) then 
                    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((m_axi_gmem4_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state19))) then 
                j_reg_271 <= add_ln114_2_reg_549;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state18) and (tile_ref_load_reg_521 = ap_const_lv1_0))) then
                add_ln114_2_reg_549 <= add_ln114_2_fu_450_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then
                gmem4_addr_reg_540 <= sext_ln114_fu_435_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                tmp_5_reg_477 <= s_12_dout(386 downto 386);
                tmp_6_reg_482 <= s_12_dout(387 downto 387);
                trunc_ln151_1_reg_472 <= s_12_dout(383 downto 352);
                trunc_ln151_9_reg_467 <= s_12_dout(287 downto 256);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, s_12_empty_n, m_axi_gmem4_ARREADY, m_axi_gmem4_RVALID, ap_CS_fsm_state11, ap_CS_fsm_state19, ap_CS_fsm_state4, ap_CS_fsm_state5, icmp_ln111_fu_388_p2, tile_ref_q0, tile_ref_load_reg_521, ap_CS_fsm_state6, ap_CS_fsm_state18, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done, icmp_ln114_fu_445_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
            ...
            when ap_ST_fsm_state11 => 
                if (((m_axi_gmem4_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state11))) then
            ...
            when ap_ST_fsm_state19 => 
                if (((m_axi_gmem4_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state19))) then
                    ap_NS_fsm <= ap_ST_fsm_state18;
                else
                    ap_NS_fsm <= ap_ST_fsm_state19;
                end if;
    ...
    add_ln114_2_fu_450_p2 <= std_logic_vector(unsigned(j_reg_271) + unsigned(ap_const_lv30_1));
    add_ln114_fu_420_p2 <= std_logic_vector(unsigned(zext_ln114_fu_416_p1) + unsigned(B2));
    ...
    ap_ST_fsm_state11_blk_assign_proc : process(m_axi_gmem4_ARREADY)
    begin
    ...
    ap_ST_fsm_state19_blk_assign_proc : process(m_axi_gmem4_RVALID)
    begin
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done)
    begin
        if ((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done = ap_const_logic_0)) then 
    ...
    gmem4_blk_n_AR_assign_proc : process(m_axi_gmem4_ARREADY, ap_CS_fsm_state11)
    begin
    ...
    gmem4_blk_n_R_assign_proc : process(m_axi_gmem4_RVALID, ap_CS_fsm_state19)
    begin
    ...
    m_axi_gmem4_ARVALID_assign_proc : process(m_axi_gmem4_ARREADY, ap_CS_fsm_state11)
    begin
        if (((m_axi_gmem4_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state11))) then 
    ...
    m_axi_gmem4_RREADY_assign_proc : process(m_axi_gmem4_RVALID, ap_CS_fsm_state19)
    begin
        if (((m_axi_gmem4_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state19))) then 
    ...
    p_ref_address0_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state4, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_address0, ap_CS_fsm_state2)
    begin
    ...
    p_ref_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, s_12_empty_n, ap_CS_fsm_state4, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_ce0, ap_CS_fsm_state2)
    begin
    ...
    p_ref_d0_assign_proc : process(ap_CS_fsm_state1, s_12_dout, tmp_6_reg_482, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_ref_d0 <= tmp_6_reg_482;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    p_ref_d1_assign_proc : process(ap_CS_fsm_state1, s_12_dout, tmp_5_reg_477, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_ref_d1 <= tmp_5_reg_477;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    p_v_y_address0_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state4, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_address0, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    p_v_y_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, s_12_empty_n, ap_CS_fsm_state4, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_ce0, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or (not(((s_12_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    p_v_y_d0_assign_proc : process(ap_CS_fsm_state1, s_12_dout, trunc_ln151_1_reg_472, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_v_y_d0 <= trunc_ln151_1_reg_472;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    p_v_y_d1_assign_proc : process(ap_CS_fsm_state1, s_12_dout, trunc_ln151_9_reg_467, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_v_y_d1 <= trunc_ln151_9_reg_467;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
    ...
    begin
        ...
        sext_ln114_fu_435_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln6_fu_425_p4),64));

    shl_ln_fu_409_p3 <= (mul_i_i_reg_535 & ap_const_lv2_0);

    tile_ref_address0_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state5, zext_ln111_fu_400_p1, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_address0)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    tile_ref_ce0_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state5, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_ce0)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    tile_ref_we0_assign_proc : process(ap_CS_fsm_state4, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_we0)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            tile_ref_we0 <= grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_we0;
        else 
    ...
    tile_y_address0_assign_proc : process(ap_CS_fsm_state4, zext_ln111_reg_511, ap_CS_fsm_state6, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_address0)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    tile_y_ce0_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state6, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_ce0)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    tile_y_we0_assign_proc : process(ap_CS_fsm_state4, grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_we0)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            tile_y_we0 <= grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_we0;
        else 
    ...
    trunc_ln6_fu_425_p4 <= add_ln114_fu_420_p2(63 downto 2);
