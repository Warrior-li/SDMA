...
module spmm_hls_dfm_Pipeline_VITIS_LOOP_114_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln114_fu_118_p2 = (ap_sig_allocacmp_j_1 + 30'd1);

assign add_ln116_fu_128_p2 = (trunc_ln116_fu_124_p1 + Dlen_load_cast);
...
assign icmp_ln114_fu_112_p2 = ((ap_sig_allocacmp_j_1 == K) ? 1'b1 : 1'b0);
...
assign trunc_ln116_fu_124_p1 = ap_sig_allocacmp_j_1[15:0];

assign zext_ln116_fu_149_p1 = add_ln116_reg_169_pp0_iter1_reg;

endmodule //spmm_hls_dfm_Pipeline_VITIS_LOOP_114_1
