...
module spmm_hls_pu_kernel_1_Pipeline_VITIS_LOOP_164_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [15:0] empty_51_fu_132_p1;
reg   [15:0] empty_51_reg_167;
reg    resA_ce0;
reg    resA_we0;
reg    resB_ce0;
reg    resB_we0;
...
wire   [63:0] i_4_cast_i_fu_115_p1;
reg   [1:0] i_4_fu_46;
...
assign add_ln164_fu_121_p2 = (i_4_fu_46 + 2'd1);
...
assign empty_51_fu_132_p1 = tile_y_q0[15:0];

assign grp_pu_comp_fu_90_ap_start = grp_pu_comp_fu_90_ap_start_reg;

assign i_4_cast_i_fu_115_p1 = i_4_fu_46;

assign icmp_ln164_fu_109_p2 = ((i_4_fu_46 == 2'd3) ? 1'b1 : 1'b0);

assign tile_value_address0 = i_4_cast_i_fu_115_p1;

assign tile_y_address0 = i_4_cast_i_fu_115_p1;

endmodule //spmm_hls_pu_kernel_1_Pipeline_VITIS_LOOP_164_1
