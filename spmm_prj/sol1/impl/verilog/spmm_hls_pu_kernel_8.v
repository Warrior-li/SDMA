...
reg   [31:0] trunc_ln151_9_reg_467;
reg   [31:0] trunc_ln151_1_reg_472;
reg   [0:0] tmp_5_reg_477;
reg   [0:0] tmp_6_reg_482;
...
reg   [63:0] gmem4_addr_reg_540;
wire    ap_CS_fsm_state10;
wire   [29:0] add_ln114_2_fu_450_p2;
reg   [29:0] add_ln114_2_reg_549;
...
reg    p_ref_we1;
reg   [0:0] p_ref_d1;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_idle;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_ready;
wire   [1:0] grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_address0;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_v_y_ce0;
wire   [1:0] grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_address0;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_ce0;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_we0;
wire   [31:0] grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_y_d0;
wire   [1:0] grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_address0;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_p_ref_ce0;
wire   [1:0] grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_address0;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_ce0;
wire    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_we0;
wire   [0:0] grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_tile_ref_d0;
reg   [29:0] j_reg_271;
wire    ap_CS_fsm_state17;
reg    grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 19'd1;
#0 grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg = 1'b0;
end
...
spmm_hls_pu_kernel_8_Pipeline_pu_save_stream_into_pu grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state3)) begin
            grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg <= 1'b1;
        end else if ((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_ready == 1'b1)) begin
            grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state17)) begin
        j_reg_271 <= 30'd0;
    end else if (((m_axi_gmem4_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        tmp_5_reg_477 <= s_12_dout[32'd386];
        tmp_6_reg_482 <= s_12_dout[32'd387];
        trunc_ln151_1_reg_472 <= {{s_12_dout[383:352]}};
        trunc_ln151_9_reg_467 <= {{s_12_dout[287:256]}};
    end
end
...
always @ (*) begin
    if ((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((m_axi_gmem4_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state11))) begin
...
always @ (*) begin
    if (((m_axi_gmem4_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign add_ln114_2_fu_450_p2 = (j_reg_271 + 30'd1);

assign add_ln114_fu_420_p2 = (zext_ln114_fu_416_p1 + B2);
...
assign grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start = grp_pu_kernel_8_Pipeline_pu_save_stream_into_pu_fu_282_ap_start_reg;

assign icmp_ln111_fu_388_p2 = ((i_fu_112 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln114_fu_445_p2 = ((j_reg_271 == trunc_ln_reg_492) ? 1'b1 : 1'b0);

assign m_axi_gmem4_ARADDR = gmem4_addr_reg_540;
...
assign m_axi_gmem4_ARLEN = K_cast10_i_reg_497;
...
assign sext_ln114_fu_435_p1 = $signed(trunc_ln6_fu_425_p4);

assign shl_ln_fu_409_p3 = {{mul_i_i_reg_535}, {2'd0}};

assign trunc_ln6_fu_425_p4 = {{add_ln114_fu_420_p2[63:2]}};
