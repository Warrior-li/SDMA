...
module spmm_hls_dfm_Pipeline_VITIS_LOOP_113_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [15:0] add_ln115_fu_128_p2;
reg   [15:0] add_ln115_reg_169;
reg   [15:0] add_ln115_reg_169_pp0_iter1_reg;
reg   [31:0] gmem6_addr_read_reg_174;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln115_fu_149_p1;
reg   [29:0] j_fu_56;
wire   [29:0] add_ln113_fu_118_p2;
wire    ap_loop_init;
reg   [29:0] ap_sig_allocacmp_j_6;
wire   [15:0] trunc_ln115_fu_124_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln113_fu_112_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln113_fu_112_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln113_reg_165 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln113_fu_112_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln113_reg_165 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln113_reg_165 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln113_reg_165 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign Dbuf_address1 = zext_ln115_fu_149_p1;

assign Dbuf_d1 = gmem6_addr_read_reg_174;

assign add_ln113_fu_118_p2 = (ap_sig_allocacmp_j_6 + 30'd1);

assign add_ln115_fu_128_p2 = (trunc_ln115_fu_124_p1 + trunc_ln);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln113_reg_165 == 1'd0) & (m_axi_gmem6_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln113_reg_165 == 1'd0) & (m_axi_gmem6_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln113_reg_165 == 1'd0) & (m_axi_gmem6_RVALID == 1'b0));
end
...
assign icmp_ln113_fu_112_p2 = ((ap_sig_allocacmp_j_6 == K) ? 1'b1 : 1'b0);
...
assign trunc_ln115_fu_124_p1 = ap_sig_allocacmp_j_6[15:0];

assign zext_ln115_fu_149_p1 = add_ln115_reg_169_pp0_iter1_reg;

endmodule //spmm_hls_dfm_Pipeline_VITIS_LOOP_113_2
