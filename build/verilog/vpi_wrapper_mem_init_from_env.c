 ...
 *     #include "vpi_wrapper_mem_init_from_env.h"
 *     void (*vlog_startup_routines[])() = { mem_init_from_env_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void mem_init_from_env(unsigned long long , char *, unsigned long long );

/* VPI wrapper function */
PLI_INT32 mem_init_from_env_calltf(PLI_BYTE8 *user_data)
{
  vpiHandle hCall;
  ...
  mem_init_from_env(arg_1, arg_2, arg_3);
...
void mem_init_from_env_vpi_register()
{
  s_vpi_systf_data tf_data;
  
  /* Fill in registration data */
  tf_data.type = vpiSysTask;
  tf_data.tfname = "$imported_mem_init_from_env";
  tf_data.calltf = mem_init_from_env_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_mem_init_from_env";
