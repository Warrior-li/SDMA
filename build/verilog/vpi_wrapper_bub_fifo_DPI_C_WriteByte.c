 ...
 *     #include "vpi_wrapper_bub_fifo_DPI_C_WriteByte.h"
 *     void (*vlog_startup_routines[])() = { bub_fifo_DPI_C_WriteByte_vpi_register, 0u };
 * 
 * For a Verilog simulator which requires a .tab file, use the following entry:
 * $imported_bub_fifo_DPI_C_WriteByte call=bub_fifo_DPI_C_WriteByte_calltf size=8 acc=rw:%TASK
 * 
 * For a Verilog simulator which requires a .sft file, use the following entry:
 * $imported_bub_fifo_DPI_C_WriteByte vpiSysFuncSized 8 unsigned
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
char bub_fifo_DPI_C_WriteByte(unsigned long long , char );
...
PLI_INT32 bub_fifo_DPI_C_WriteByte_calltf(PLI_BYTE8 *user_data)
{
  ...
  vpi_result = bub_fifo_DPI_C_WriteByte(arg_1, arg_2);
...
/* sft: $imported_bub_fifo_DPI_C_WriteByte vpiSysFuncSized 8 unsigned */

/* tab: $imported_bub_fifo_DPI_C_WriteByte call=bub_fifo_DPI_C_WriteByte_calltf size=8 acc=rw:%TASK */

PLI_INT32 bub_fifo_DPI_C_WriteByte_sizetf(PLI_BYTE8 *user_data)
{
  return 8u;
}
...
void bub_fifo_DPI_C_WriteByte_vpi_register()
{
  ...
  tf_data.tfname = "$imported_bub_fifo_DPI_C_WriteByte";
  tf_data.calltf = bub_fifo_DPI_C_WriteByte_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = bub_fifo_DPI_C_WriteByte_sizetf;
  tf_data.user_data = "$imported_bub_fifo_DPI_C_WriteByte";
